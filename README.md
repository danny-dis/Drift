<p align="center">
  <img src="icon.png" alt="Drift" width="500">
</p>
...
```bash
# Terminal 1 — backend
uv run python drift/main.py   # or: python drift/main.py
